...
public class SubscribePage {
    ...
    private static final String PAGE_TITLE = "//h2[contains(normalize-space(text()), 'Subscribe')]";
   // private static final String FORMIFRAME = "//iframe[@id='sfmcform']";
    ...
    private static final String FIELDS = "//label[normalize-space(text())='$value$']";


    private static final String FIELDREQUIRED = "//label[contains(normalize-space(text()),'$value$')]/span[@class='required']";
    private static final String TYPEOFFIELD ="//label[contains(normalize-space(text()),'$value$')]/following-sibling::input";

    private static final String DROPDOWNFIELD = "//label[contains(normalize-space(text()),'$value$')]/following-sibling::select";

    private static final String RECAPTCHA = "//div[normalize-space(text())='reCAPTCHA']";
